...
class VoteRecordsControllerTest < ActionController::TestCase
  ...
  test "should create vote_record" do
    assert_difference('VoteRecord.count') do
      post :create, vote_record: { is_yes: @vote_record.is_yes, question_id: @vote_record.question_id, voter_id: @vote_record.voter_id }
    end
  ...
  test "should update vote_record" do
    patch :update, id: @vote_record, vote_record: { is_yes: @vote_record.is_yes, question_id: @vote_record.question_id, voter_id: @vote_record.voter_id }
    assert_redirected_to vote_record_path(assigns(:vote_record))
  end
